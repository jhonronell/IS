...
<!-- Modal -->
<form method="post" action="${pageContext.request.contextPath}/products/newProduct">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="row form-group">
						<div class="col-md-10">
							<div>
								<label label-default="" class="control-label " for="textinput">Model</label>
							</div>
							<input class="typeahead form-control" name="model" type="text"
								placeholder="Countries">
						</div>
						<div class="col-md-2">
							<label label-default="" class="control-label " for="textinput">Year
								Model</label> <select name="yearModel" class="form-control">
